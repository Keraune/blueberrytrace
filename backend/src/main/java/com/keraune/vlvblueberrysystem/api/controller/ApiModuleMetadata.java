...
final class ApiModuleMetadata {
    ...
    static List<EndpointResponse> endpoints() {
        return List.of(
                ...
                new EndpointResponse("PUT", "/api/v1/siembras/{id}", "Actualización de siembras desde clientes React/Vue."),
                ...
                new EndpointResponse("PUT", "/api/v1/procesos/uniformizaciones/{id}", "Actualización de uniformizaciones desde clientes React/Vue."),
                ...
                new EndpointResponse("PUT", "/api/v1/procesos/formalizaciones/{id}", "Actualización de formalizaciones desde clientes React/Vue."),
                ...
                new EndpointResponse("PUT", "/api/v1/clasificaciones/{id}", "Actualización de clasificaciones desde clientes React/Vue."),
