...
import { AlertTriangle, CheckCircle2, Clock3, Download, Eye, PackageCheck, Pencil, Plus, RefreshCcw, Truck } from 'lucide-react';
...
export function DespachoPage({ despachos, lotes, modalidades, validaciones, onDespachosChange }: DespachoPageProps) {
  ...
  const summary = [
    { label: 'Total despachado', value: plantas, suffix: 'plantas', tone: 'green', icon: <Truck size={18} /> },
    { label: 'En seguimiento', value: enSeguimiento, suffix: 'plantas', tone: 'blue', icon: <Clock3 size={18} /> },
    { label: 'Cerrados', value: cerrados, suffix: 'registros', tone: 'purple', icon: <CheckCircle2 size={18} /> },
  ...
  return (
    <main className="content-grid dispatch-screen">
      ...
      <div className="tab-switcher">
        <button type="button" className={tab === 'historial' ? 'tab-switcher__item tab-switcher__item--active' : 'tab-switcher__item'} onClick={() => setTab('historial')}><PackageCheck size={15} /> Historial de despachos</button>
