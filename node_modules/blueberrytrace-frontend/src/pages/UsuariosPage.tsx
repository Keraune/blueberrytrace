  ...
  return (
    <main className="content-grid">
      ...
      <section className="summary-strip summary-strip--three">
        ...
        <article className="summary-pill summary-pill--purple"><span className="summary-pill__icon"><ShieldCheck size={18} /></span><strong>{availableRoles.length}</strong><span>Roles</span><small>perfiles corporativos</small></article>
      </section>
